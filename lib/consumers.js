...
ConsumerInstance.prototype.subscribe = function(topic, requestDelay) {
    var stream = new ConsumerStream(this, topic, requestDelay);
...
var ConsumerStream = function(instance, topic, requestDelay) {
    EventEmitter.call(this);
        ...
        if (err) {
            ...
            if (this.active) {
                if(this.requestDelay){
                    setTimeout(this.read.bind(this), this.requestDelay);
                } else {
                    this.read();
                }
            } else {
